...
export default class ProcessDoubtingMainHelp extends React.Component
{
  render()
  {
    return (
...
Le raccolte di racconti sono riconoscibili con gli stessi colori anche in modalità Cronologia, attraverso l’utilizzo di alcuni contorni (metaballs).</p>
  ...
  <h3>Come si esplora il process-dubitare</h3>
<h4>Informazioni</h4>
...
<div className="sheet--info">
  <ArrowButton arrowDirection="left" textAlign="right" text="SCHEDA" route="/Process/doubting/Hesitation/informationSheet" />
  <ArrowButton arrowDirection="left" textAlign="right" text="TAPPA 1" route="/Phenomena/territory/doubtAnalysis" />
