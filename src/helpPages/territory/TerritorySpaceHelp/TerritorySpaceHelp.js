...

{
  render()
  {
    return (
      ...
      <p> Abbiamo individuato cinque categorie, che ci permettessero di fornire una mappatura il più possibile completa: luoghi generici non terrestri (es. <em>lo spazio</em>), luoghi nominati non terrestri (es. <em>la Luna</em>), luoghi nominati terrestri (es. <em>Sanremo</em>), luoghi generici terrestri (es. <em>una vallata</em>) e luoghi inventati (es. <em>Ombrosa</em>).</p>
      <p> Generalmente, ogni testo presenta più luoghi d’ambientazione e non sempre appartenenti alla stessa categoria. Inoltre, può capitare che un luogo d’ambientazione contenga a sua volta un altro luogo e sia dunque necessario segnalare anche il rapporto gerarchico che li contraddistingue.</p>
