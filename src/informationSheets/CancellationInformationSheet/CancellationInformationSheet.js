        ...
        <main className={SheetStyles.main}>
          <div className={SheetStyles.gridRow}>
            ...
            <h1 className={SheetStyles.titleH1}>
              Il dubbio e la cancellazione
            </h1>
            <h2 className={SheetStyles.titleH2}>Un racconto esemplare</h2>
            <p className={SheetStyles.paragraph}>
              <em>L’avventura di un soldato</em> (1949) è il racconto che
              ...
              <em>Gli amori difficili</em> (1970). Come spiega lo stesso Calvino
              nella nota introduttiva al volume, «ciò che sta alla base di molte
              di queste storie è una difficoltà di comunicazione, una zona di
              silenzio al fondo dei rapporti umani» (Calvino 2011, p. XII). Nel
              racconto il fante Tomagra si trova seduto nello scompartimento di
              un treno, quando accanto a lui prende posto una donna vestita in
              lutto. La trama del racconto consiste nel susseguirsi delle
              manovre di seduzione del soldato, che potrebbero permettergli di
              creare un legame con la vedova. Legame tuttavia fragile e incerto
              poiché i suoi gesti «appaiono ora vittorie gigantesche e
              irreversibili ora precarie illusioni prive di conferma» (ibidem).
              Alla “difficoltà comunicativa” si aggiunge quindi un altro
              ostacolo: Tomagra si muove in un universo semanticamente
              instabile, di cui non riesce a interpretare con certezza i segni.
              Questi due elementi sono strettamente legati a quello che abbiamo
              definito il testo dubitativo.
              <br />
              <br /> Nella visualizzazione generale{" "}
              <em>L’avventura di un soldato</em> si situa a destra della linea
              verticale, in una delle fasce più esterne, relativamente isolato
              rispetto agli altri elementi grafici. Nonostante non ci siano vere
              e proprie aggregazioni, la sua orbita rasenta quella di alcuni
              testi significativi: il più vicino <em>Campo di mine</em> (1946),
              altra eccezione, subito affiancato da{" "}
              <em>Ricordo di una battaglia</em> (1974). Anche lo sviluppo di
              questi due racconti ruota attorno a un processo dubitativo: da un
              lato la storia di un uomo che attraversa una valle minata,
              tentando di interpretare le gobbe e le depressioni del terreno in
              cerca di un indizio che possa indicargli il giusto cammino;
              dall’altro un personaggio che prova a ricostruire il ricordo di
              una battaglia, lottando contro il disfacimento ineluttabile della
              memoria. Nei tre racconti la griglia ha una composizione simile:
              la categoria della <span style={{ color: "#00bfd3" }}>forma</span>{" "}
              è quasi del tutto assente, a favore di quella del{" "}
              <span style={{ color: "#FFA500" }}>contenuto</span> e del{" "}
              <span style={{ color: "#ff3366" }}>significato</span>;
              parallelamente, gli stili dominanti sono l’<em>esitazione</em> e
              la <i>negazione</i>. Il mondo è mutevole sotto diversi aspetti:
              l’oggetto della narrazione sfugge, così come la sua
              interpretazione. Per questo la voce narrante afferma, poi dubita e
              cancella, tornando sui propri passi e prendendo un’altra
              direzione.
              <br />
              <br />
              L’alta concentrazione di testo dubitativo e la sua particolare
              posizione nella visualizzazione rendono{" "}
              <em>L’avventura di un soldato</em> un interessante caso studio su
              cui soffermarsi per capire meglio come funzioni la griglia
              d’analisi che ci ha guidato nella creazione della visualizzazione.
            </p>
            <div className={SheetStyles.sideContent}>
              ...
              <p className="captionLeft">
                Posizione di <em>L’avventura di un soldato</em> nella terza
                tappa <em>Cancellazione</em>
              </p>
              <img
              ...
              />
              <p className="captionLeft">
                Distribuzione delle occorrenze di testo dubitativo in{" "}
                <em>L’avventura di un soldato</em> in base alla griglia
                d’analisi
              </p>
            </div>
          </div>
          <div className={SheetStyles.gridRow}>
            ...
            <p className={SheetStyles.paragraph}>
              ...
              Ricominciare (§9-24); c. Buio e attesa (§25-26); d. Cancellazione
              (§27-31). In questo Approfondimento, il testo è visualizzato nella
              sua interezza: a ogni parola è stato sostituito un simbolo, in
              modo tale da poter mappare con estrema precisione l’estensione del
              processo dubitativo e, soprattutto, la presenza delle varie{" "}
              <em>categorie</em> e <em>stili</em> della griglia. A ogni
              occorrenza del testo dubitativo è stato attribuito un numero
              crescente, preso come punto di riferimento durante l’analisi.
              <br></br>
            </p>
            <div
          ...
          <div className={SheetStyles.gridRow}>
            ...
            >
              <br></br>Nella prima sezione le occorrenze di testo dubitativo
              ...
              <em>RR</em>, I, 319) (
              <span style={{ color: "#FFA500" }}>2, 3</span>). Ma ben presto si
              profila un’altra ipotesi: la signora potrebbe voler stabilire un
              contatto con lui.
              <br />
              <br />
              ...
              apparente distacco. In quest’avventura, il potere della percezione
              visiva del mondo sembra messo sotto scacco dalla segretezza delle
              manovre di seduzione che sono gestuali: in tal modo Tomagra viene
              spinto a trovare un’altra strada per capire il senso di ciò che
              sta accadendo. Nel corpo principale del testo si succedono allora
              tre domande: «che non se ne fosse accorta ancora? Oppure che
              preparasse una fuga? O una rivolta?» (ivi, 321) (
              <span style={{ color: "#FFA500" }}>7-9</span>). Compare qui per la
              prima volta nel racconto il punto interrogativo, segno
              interpuntivo che sembra suscitare un’evoluzione dell’atteggiamento
              dubitativo. Subito dopo, infatti, notiamo la presenza di
              occorrenze appartenenti al{" "}
              <span style={{ color: "#ff3366" }}>significato</span>: nel 8§
              Tomagra decide di prendere l’iniziativa e «di trasmetterle, in
              qualche modo, un <em>messaggio</em>» (ibidem, c.n.) che vada oltre
              le semplici apparenze; il corpo compierà un’azione che avrà un
              ...
              meccanismo che porta avanti il racconto fino alla sua conclusione:
              agire, cercando un punto di contatto con la vedova e sforzandosi
              di rendere le proprie azioni comprensibili. Per rendersi
              rapidamente conto, invece, che niente di quello che sta facendo ha
              un significato esplicito. Come succede anche ai segnali che la
              donna invia a sua volta: l’unica strategia possibile, allora, sarà
              quella di sottrarsi momentaneamente, arretrare per poi
            ...
            <p
              ...
              style={{ marginTop: "1rem" }}
            >
              <br></br>L’andirivieni mentale e fisico di Tomagra appena
              descritto riflette con estrema fedeltà il comportamento del testo
              dubitativo. Nell’articolo{" "}
              <em>La notte del morto nel paese nemico</em>, Francesca Serra
              descrive il meccanismo dubitativo su cui è costruito{" "}
              <em>Ricordo di una battaglia</em>, ribattezzandolo «racconto
              negato» in quanto si basa su «un riflesso metanarrativo che mina
              nel profondo la costituzione lineare del racconto, tornando sempre
              indietro a contraddirne delle parti» (Serra 2010, 129) e dando
              così vita a una serie potenzialmente infinita di nuovi inizi.
              Nelle prime righe del 9§, Tomagra conclude fra sé che, avendo
              perso «quella paziente e prudentissima opera di contatto»,
              «bisognava ricominciare da capo» (<em>RR</em>, I, 321).
              Successivamente riprenderà la sua «opera» più volte, dando modo al
              testo dubitativo di intensificarsi e diversificarsi, accompagnando
              i movimenti e i dubbi del soldato.<br></br>
              Osservando la visualizzazione, si percepisce un uso eterogeneo sia
              delle categorie che degli stili; notiamo un’alternanza cadenzata
              fra le occorrenze di{" "}
              <span style={{ color: "#FFA500" }}>contenuto</span> e le
              occorrenze di{" "}
              <span style={{ color: "#ff3366" }}>significato</span>; compare in
              misura minore la categoria{" "}
              <span style={{ color: "#00bfd3" }}>forma</span>. Nel complesso
              potremmo sostenere che l’andamento narrativo e il processo
              dubitativo avanzano parallelamente fra loro.<br></br>
              Al centro di questo andirivieni non si trova, però, il personaggio
              nella sua interezza. Piuttosto la sua mano, rappresentata come
              un’entità a sé stante, una sorta di appendice dotata di volontà
              propria (cfr. ivi, 322). Le due occorrenze{" "}
              ...
              muscolo della coscia l’immagine di un pugno; la mano in seguito si
              metamorfoserà in «farfalla», «topo», «polpo», «granchio»,
              ...
              lo stile maggiormente usato: nella visualizzazione, il suo impiego
              si estende dall’inizio (
              <span style={{ color: "#ff3366" }}>10</span>) alla fine del
              racconto (<span style={{ color: "#ff3366" }}>56</span>),
              solitamente nello sforzo frustrato di chiarire una volta per tutte
              il senso che sta dietro ai gesti.<br></br>
              <br></br>
              La parcellizzazione del corpo di Tomagra riflette il modo in cui
              viene descritto lo scambio muto di gesti fra lui e la vedova: ogni
              minimo movimento è oggetto di un’analisi minuziosa che non
              ...
              Focalizzarsi unicamente sul dettaglio provoca una strana forma di
              miopia in cui ogni cosa, ingigantita e deformata, può comunque
              significare qualcos’altro. Dalla visualizzazione emerge che la
              categoria del{" "}
              <span style={{ color: "#ff3366" }}>significato</span> nelle pagine
              centrali del testo viene impiegata diversamente, adottando lo
              stile dell’<em>esitazione</em> (25, 26, 28, 29, 37); la prima fra
              ...
              <span style={{ color: "#ff3366" }}>significato</span> non riescono
              più a riformulare il senso di un gesto trasformandolo in un
              messaggio chiaro, bensì si limitano ad accumulare ipotesi. Un modo
              per Tomagra di ottenere una risposta potrebbe essere basarsi sulle
              reazioni della vedova, ma «lei, lei, lei era una sfinge» (ibidem),
              ennesimo simbolo che rappresenta l’enigma femminile e,
              contemporaneamente, il principio di metamorfosi che altera la
              realtà.<br></br>
              La conclusione del ventiquattresimo paragrafo riprende la frase
              iniziale della sezione: Tomagra è arretrato per l’ennesima volta,
              eppure esita, «come volesse <em>ricominciare da capo</em> il suo
              pazientissimo lavoro e non fosse sicuro ormai delle profonde mete
              già raggiunte. Ma le aveva davvero raggiunte? Oppure era stato
              solo un sogno?» (ivi, 326, corsivo nostro) (
              <span style={{ color: "#ff3366" }}>43</span>,{" "}
              <span style={{ color: "#FFA500" }}>44</span>,{" "}
              <span style={{ color: "#FFA500" }}>45</span>). L’intera manovra di
              seduzione si sbriciola sotto la pressione del dubbio che in realtà
              nulla sia avvenuto come il soldato lo ha immaginato: Tomagra si è
              illuso della complicità raggiunta con la vedova. Qui compaiono,
              infatti, le parole “profondità” e “sogno”, per evocare una
              dimensione onirica e sospesa di assoluta incertezza, subito
              ripresa nella sezione successiva.<br></br>
              <br></br>
            </p>
            <img
              className={SheetStyles.image}
            ...
            <p
              ...
              style={{ marginTop: "1rem" }}
            >
              <br></br>«Una galleria piombò loro addosso» (ivi, 326). Cala
              ...
              <span style={{ color: "#FFA500" }}>48</span>) oppure «era un segno
              che tutto ciò era vero, che lei accettava» (
              <span style={{ color: "#ff3366" }}>50</span>) (ivi, 327, c.n.).
              Dove la parola “segno” prima è usata in maniera figurata,
              indicando l’esistenza di un limite, di un confine da non superare,
              poi si trasforma nel sintomo, nella prova-simbolo della
              partecipazione da parte della vedova a quello scambio con il
              soldato. Rivelando che il linguaggio è il primo veicolo
              dell’ambiguità che avvolge il mondo reale.<br></br>
              <br></br>
              ...
              occorrenze di <span style={{ color: "#FFA500" }}>
                contenuto
              </span>{" "}
              del paragrafo il soldato rimugina su quanto sia ancora lunga la
              galleria, se valga la pena tentare nuovamente qualcosa
              approfittando dell’oscurità. Ma il tempo sta per scadere e i dubbi
              allontanano sempre di più la possibilità di agire: «certo in
              queste riflessioni si era perduto molto tempo […] certo però la
              galleria era lunga […] certo se subito avesse approfittato avrebbe
              avuto molto tempo innanzi a sé» (
              <span style={{ color: "#FFA500" }}>51-53</span>) (ibidem). Il
              paragrafo rappresenta l’attesa, parola latina composta da{" "}
              <em>ad</em>- per “verso” e <em>téndere</em> nel senso traslato di
              “mirare, aspirare” ma che significa anche “tirare”: il testo si
              dilata, si gonfia tramite il processo dubitativo, si “tende”
              aumentando il proprio spazio sulla pagina. Al centro del racconto
              si trovano così i gesti assenti, le deduzioni incerte, un impulso
              sistematico ad annullare ogni forma di progressione: un articolato
              stratagemma per prolungare l’attesa, allontanando
              contemporaneamente la fine.<br></br>
              <br></br>
            </p>
            <img
              className={SheetStyles.image}
