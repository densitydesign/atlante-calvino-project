        ...
        <main className={SheetStyles.main}>
          <div className={SheetStyles.gridRow}>
            ...
            <h2 className={SheetStyles.titleH2}>
              {this.props.t("realismo-sheet:L'idea")}
            </h2>
            <Trans
            ...
            >
              <p className={SheetStyles.paragraph}>
                ...
                analisi sul movimento narrativo nello spazio, questi racconti
          ...
          <div className={SheetStyles.gridRow}>
            ...
            >
              <p className={SheetStyles.paragraph}>
                ...
                giusta da seguire (per riuscire a fuggire, per raggiungere il
              ...
              <p className={SheetStyles.paragraph}>
                ...
                Percentualmente, l’84% dei sostantivi utilizzati nel testo
                afferiscono a un lessico concreto, soltanto il 16% a un lessico
            ...
            >
              <p className={SheetStyles.paragraph}>
                ...
                finisce per credere che ci sia «un tedesco per ogni cespuglio,
                un tedesco appollaiato in cima a ogni albero, coi ghiri. Le
                pietraie pullulavano d’elmi, fucili s’alzavano tra i rami, le
                radici degli alberi finivano in piedi umani. Binda marciava
                lungo una doppia siepe di tedeschi in agguato, che lo guardavano
                con occhi luccicanti come foglie: più camminava più
                s’approfondiva in mezzo a loro». Si tratta di un vero e proprio
