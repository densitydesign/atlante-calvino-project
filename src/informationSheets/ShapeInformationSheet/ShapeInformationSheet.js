...
export default class ShapeInformationSheet extends React.Component
{
  ...
  <div className={SheetStyles.gridRow}>
      ...
      un’esperienza di prigionia, viene colto dal «male dei simboli» (RR, I, 237)
    ...
    <div className={SheetStyles.gridRow}>
      ...
      diversi, è la netta preferenza di Calvino per una procedura elencatoria
      che coinvolga elementi complessi come  <span style={{color:'#ffa500'}}>sintagmi</span> e addirittura intere
      <span style={{color:'#5151fc'}}> proposizioni</span>, gesto che, in termini retorici, costituisce il polo opposto
      all’<em>accumulatio</em>, vale a dire la <em>distributio</em>: quel formato enumerativo in
    ...
    <div className={SheetStyles.gridRow}>
      ...
      gesto che sembrerebbe suggerire una volontà di semplificazione e di sfida
      alla struttura classica dell’arco drammatico (Freytag 1990), si manifesta
      anche la massima ricerca di complessità nella costruzione delle unità
      elencate, che in alcuni casi si espandono e articolano fin quasi a
      oscurare la riconoscibilità dell’elenco in quanto tale. Ma questi elenchi,
      e quelli di proposizioni in particolare, sono anche un segnale importante
      delle scelte estetiche generali dell’autore, perché cancellando i nessi
      causali a favore della semplice sequenza temporale (in cui un evento è
      raccontato mettendo in fila i singoli momenti che lo compongono, come un
      film che venga mostrato un fermo-immagine alla volta) rievocano
      l’andamento delle cronache e degli annali, forme tradizionalmente
      considerate opposte all’arte narrativa perché prive di trama, e in questo
      modo contribuiscono a posizionare Calvino in una lunga tradizione di
      letteratura «non-aristotelica» (Orr 1991) che risale fino a Sterne.
      </p>
    </div>
