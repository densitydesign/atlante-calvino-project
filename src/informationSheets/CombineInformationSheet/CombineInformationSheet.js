        ...
        <main className={SheetStyles.main}>
          <div className={SheetStyles.gridRow}>
            ...
            <h2 className={SheetStyles.titleH2}>
              Compatto vs molteplice: un passaggio sfumato
            </h2>
            <p className={SheetStyles.paragraph}>
              ...
              passaggio critico obbligato, soprattutto quando si tratta di testi
              scritti a partire dalla seconda metà degli anni Sessanta. È del
              resto difficile ignorare il netto riorientamento poetico che, nel
              giro di pochi anni, porta la scrittura calviniana a passare dai
              toni e dalle forme con cui aveva conquistato la notorietà
              letteraria, quelli della trilogia degli antenati (1952, 1957,
              1959), dei <em>Racconti</em> (1958) e di <em>Marcovaldo</em>{" "}
              (1963), al gusto geometrico e metaletterario che caratterizza
              l’ultimo ventennio. Dalle <em>Città invisibili</em> (1972), al{" "}
              <em>Castello dei destini incrociati</em> (1973), fino a{" "}
              <em>Se una notte d’inverno un viaggiatore</em> (1979), a dominare
              l’interesse calviniano è il rapporto tra modello e variante, la
              costruzione modulare vista come innesco non solo di
              un’esplorazione della fantasia, ma anche come esercizio cognitivo
              e metaletterario, in quanto produce un tipo di testo che «mostra
              visibilmente come è costruito: esso è cioè sempre autoriflessivo»
              ...
              ripubblicazione, perché dimostra la capacità di Calvino di tenere
              al centro della propria attenzione due operazioni parallele ma
              distantissime come la raccolta in volume della serie cosmicomica,
              la sua produzione più fresca, realizzata a ritmi serrati durante
              l’anno immediatamente precedente quasi senza concessioni ad altre
              forme, e la raccolta in volume di due opere del decennio
              precedente, rimaste sempre in sospeso per l’impossibilità di
              trovare loro una collocazione certa, non solo in termini di genere
              e di sede editoriale, ma anche e forse soprattutto all’interno del
              percorso dell’autore. I due testi, infatti, sospesi appena oltre
              la soglia del racconto lungo, appartengono a quella tonalità,
              minoritaria in Calvino, che tenta di recuperare atmosfere e
              situazioni dalla tradizione del realismo modernista per dipingere
              ...
              valore di questo formato del «grigiore».
            </p>
          </div>
          <div className={SheetStyles.gridRow}>
          ...
          <div className={SheetStyles.gridRow}>
            ...
            <p className={SheetStyles.paragraph}>
              ...
              loro rispettive strutture per condurre una più accurata autopsia,
              ecco che la nostra indiscutibile impressione di lettura deve
              confrontarsi con alcune risposte sorprendenti. Quando andiamo a
              cimentarci nell’esercizio pratico di contare le “particelle
              elementari” che compongono i testi raccolti nei due libri,
          ...
          <div className={SheetStyles.gridRow}>
            <h2 className={SheetStyles.titleH2}>
              Salti di ambito, o il potere dell’assemblaggio strategico
            </h2>
            <img
              className={SheetStyles.image}
              style={{ gridColumn: " 1 / span 10",  position:'sticky',top:'calc(var(--navigation-height)', paddingTop:'1rem',paddingBottom:'1rem', backgroundColor:'var(--white)'}}
            ...
            <p className={SheetStyles.paragraph}>
              ...
              intermedia sia dallo zoom estremo che abbiamo appena sperimentato
              sia dall’approssimativo sguardo d’insieme con cui abbiamo
            ...
            <p className={SheetStyles.paragraph}>
              ...
              dell’«accadere pubblico intersoggettivo» (Szondi 2000, 9) restano
              ben delimitati e riconoscibili. Questo stratagemma compositivo,
              che con una piccola manipolazione quasi invisibile riesce a creare
              un impatto vistosissimo sul risultato, non solo dimostra quanto la
              scrittura calviniana sia effettivamente «un puzzle magistrale»
              (Barthes 2002, 182), ma è anche responsabile di una serie di
              effetti artistici secondari. Uno su tutti, la sensazione di
              profondità dei due racconti realistici, nei quali la complessità
              del mondo, che nelle <em>Cosmicomiche</em> è tutta sulla ribalta,
              interamente accessibile ai personaggi che la percorrono in lungo e
              in largo, è intrappolata in zone inagibili e spinta sullo sfondo,
              ma rimane comunque presente come un baluginio sul fondo di uno
              specchio d’acqua
            </p>
          </div>
          <div className={SheetStyles.gridRow}>
            <h2 className={SheetStyles.titleH2}>
              Incontrare qualcuno: il gusto della serie (quasi) perfetta
            </h2>
            <p className={SheetStyles.paragraph}>
              ...
              sull’elemento dell’incontro. Nell’ordine, la prima è una serie di
              due ripetizioni della sequenza
              incontro-iniziativa-speranza-delusione (il protagonista
              interagisce con un personaggio e individua un piano per affrontare
              il problema dell’infestazione, attraversa un momento di euforia, e
              poi perde fiducia e sprofonda nell’angoscia per il probabile
              insuccesso); la seconda è una serie di tre ripetizioni della
              sequenza incontro-delusione (il protagonista cerca di consultarsi
