...
<img src={process.env.PUBLIC_URL + "/informationSheets/infosheet-nebbia-02.png"} alt="information complement" style={{width:'70%', paddingBottom:'50px', paddingTop:'30px'}}/>
</div>
...
<article className="focus">
          ...
          <img src={process.env.PUBLIC_URL + "/informationSheets/infosheet-nebbia-01.png"} alt="information complement" style={{width:'70%', paddingBottom:'50px', paddingTop:'30px'}}/>
        </div>
