...
<article className="focus">
          ...
          <h3>Fine e inizio, astratto e concreto</h3>
            <img src={process.env.PUBLIC_URL + "/informationSheets/infosheet-nebbia-02.png"} width="300px" className="viz--pic" alt="information complement" />
          <p>
...
<article className="focus-2">
          ...
          <img src={process.env.PUBLIC_URL + "/informationSheets/infosheet-nebbia-01.png"} width="300px" className="viz--pic" alt="information complement" />
