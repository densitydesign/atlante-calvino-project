        ...
        <h4 className="ac-breadcrumb">Tappa 1 > nebbia</h4>
          ...
          <img className={SheetStyles.legend} style = {{gridColumn:'1 / span 12'}}  src={legenda}/>
                  ...
                  <DoubtTypePerYearWrapper  />
                    ...
                    <p className={SheetStyles.paragraph}> Il grafico mostra i
                    ...
                    categorizzate nella raccolta dati come <em>astratte</em> o come <em>concrete</em>.
                    < br/>
                  ...
                  <div className={SheetStyles.gridRow}>
                    <h2 className={SheetStyles.titleH2}>La nebbia che non c’è</h2>
                      ...
                      tarde di Calvino, probabilmente non è il vero e proprio
                      elemento atmosferico, bensì una forma di simulazione delle
                ...
                <div className={SheetStyles.gridRow}>
                    <h2 className={SheetStyles.titleH2}>Ostacoli visivi</h2>
                      <p className={SheetStyles.paragraph}>
                      All’inizio degli anni Sessanta, prima di dare vita al nuovo personaggio
                      cosmicomico Qwfwq, Calvino porta a termine il lungo percorso che negli anni
                      Cinquanta aveva riguardato il personaggio di Marcovaldo. Nel 1963 vengono
                      pubblicati gli ultimi racconti della serie che ha per protagonista Marcovaldo,
                      fra cui <em>La fermata sbagliata</em>: Marcovaldo va al cinema e uscendo dopo l’ultimo
                      spettacolo scopre che la città è stata invasa dalla nebbia; incapace di trovare
                      dei punti di riferimento per orientarsi, scende alla fermata sbagliata del tram
                      e si perde. L’anno successivo, nel 1964, esce su «il Caffé» un racconto
                      cosmicomico intitolato <em>Un segno nello spazio</em>: Qwfwq si decide dopo un lungo
                      periodo di incertezza a lasciare un segno personale nell’universo, simbolo di se
                      stesso ma anche punto di riferimento nello spazio sconfinato in cui si trova.
                      ...
                      transizione: la pubblicazione di <em>Marcovaldo</em> ha la funzione di «chiudere
                      definitivamente una fase della sua vita e nell’annunciarne una nuova», lasciando
                      una volta per tutte dietro di sé «l’impegno politico degli anni cinquanta»
                      (Scarpa 2005, 29); il racconto cosmicomico invece «è un genere letterario con il
                      quale egli si reinventa come scrittore» (ivi, 32). Il progressivo alzarsi e
                      abbassarsi delle diverse onde nella visualizzazione rispecchia questo cambio di
                      rotta: si scopre, infatti, che l’inversione di tendenza che riguarda il
                      passaggio dal concreto all’astratto avviene proprio nell’intervallo
                      visualizzato. Da questo momento in poi la cancellazione avrà la meglio sulla
                      nebbia.</p>
