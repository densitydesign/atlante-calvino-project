        ...
        <main className={SheetStyles.main}>
          <div className={SheetStyles.gridRow}>
            <div style={{ gridColumn: "1 / span 22" }}>
              ...
              <h2>L'idea</h2>
              <img
                className={SheetStyles.imageTrasp}
                style={{ width: "100%" }}
                src={inquadramento}
              />
            </div>
          ...
          <div className={SheetStyles.gridRow}>
            ...
            <p className={SheetStyles.paragraph}>
              ...
              partire dalla definizione inglese di imported places (Piatti et
              al. 2009), è l’unica che per caratteristiche intrinseche si presta
              a una rappresentazione cartografica. Si tratta infatti di
              ambientazioni localizzabili su una mappa, poiché «the setting
              corresponds with the geographical reality by realistically
              portraying the surrounding» (Reuschel-Hurni 2011, 296).
              ...
              <ol>
                ...
                <li>
                  Ambientazioni di testi in cui il tempo della storia è
                  collocato nel passato o in un tempo indefinito (ad es. Il
                  visconte dimezzato è ambientato al tempo di Carlo Magno, Le
                  città invisibili nel 1200).
                </li>
                <li>
                  Ambientazioni di testi in cui presente e passato si fondono in
                  un tempo della storia misto (ad es. nel racconto I cristalli
                  l’ambientazione pre-cosmica e primordiale presenta riferimenti
                  geografici della New York contemporanea).
                </li>
              </ol>
                ...
                <Carousel.Item>
                  <Carousel.Caption>
                    ...
                    <div className={SheetStyles.gridRow}>
                      ...
                      <img
                        className={
                          SheetStyles.sideContent + " " + SheetStyles.imageTrasp
                        }
