    ...
    return (
      ...
      <h2 className={SheetStyles.titleH2}>Parole: scegliere, interpretare, precisare </h2>
        ...
        <div className={SheetStyles.gridRow}>
          ...
          <img className = {SheetStyles.image} style ={{gridColumn:"1 / span 8", position:'sticky',top:'calc(var(--navigation-height) + 0.3rem)', backgroundColor:'var(--white)'}} src={zoom_02}/>
          <p className={SheetStyles.paragraph}>
              Il paragrafo finale di questa parte del libro (<em>RR</em>, II, 9-11) è composto da più
              ...
              passaggio dal 6° al 7° livello avviene a causa del <strong>td29</strong>; poteva sembrare che il
              ...
              <p className={SheetStyles.paragraph}>Alla fine del secondo capitolo della <em>Giornata d’uno scrutatore</em>, il testo si
              sviluppa su piani diversi, i quali a volte collaborano, a volte confliggono. La
              struttura a strati sovrapposti, come le «foglie d’un carciofo» (<em>RR</em>, II, 9), da
              una parte si sforza di garantire maggiore chiarezza alla lettrice/lettore,
              dall’altra li disorienta. Si tratta di un meccanismo narrativo basato sul
              difficile rapporto fra la ricerca dell’esattezza della scrittura e l’insuccesso
              dell’atto interpretativo, per cui l’unico modo per parlare della «complessità
              delle cose» (<em>ibidem</em>) sembra essere quello di organizzarla in strati.
              < br/>
              La parentesi e l’inciso generano questa stratificazione, attraverso una forma
              grafica che introduce un altro spazio, un altrove rispetto al discorso
              principale. Tale sdoppiamento del testo viene ulteriormente potenziato dal
              processo dubitativo, che rinforza l’effetto di stratificazione in una modalità
              meno visibile.</p>
              </div>
          ...
          <h2 className={SheetStyles.titleH2}>Bibliografia</h2>
            ...
            Barenghi 2009: M. Barenghi, <em>Calvino</em>, Bologna, Mulino.
              ...
              <li className="referenceItem">
              Mengaldo 1996: P.V. Mengaldo, <em>Aspetti della lingua di Calvino</em>, in Id., <em>La tradizione del Novecento</em>, Torino, Einaudi, pp. 227-291.
              </li>
          </ol>
          </div>
