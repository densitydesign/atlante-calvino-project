    ...
    return (
      ...
      <main className={SheetStyles.main}>
        <div className={SheetStyles.gridRow}>
          <h4 className="ac-breadcrumb">Tappa 1 > luoghi</h4>
          <h1 className={SheetStyles.titleH1}>La forma della geografia inventata</h1>
        </div>
        <div className={SheetStyles.gridRow}>
        ...
        <div className={SheetStyles.gridRow}>
        <h2 className={SheetStyles.titleH2}>I romanzi</h2>
        ...
        <div className={SheetStyles.gridRow} style={{marginTop:'3rem'}}>
          <div className={SheetStyles.paragraph}>
            ...
            miracolosamente salvo per metà, fa ritorno a casa. Terralba si trova in Italia e
            appartiene alla Repubblica di Genova: è dunque all’interno di uno spazio reale e
            definito che hanno luogo le avventure fantastiche del protagonista.</p>
            <br />
            <p>In apparenza questo non accade nel <em>Barone rampante</em>, ambientato
            nel libero comune di Ombrosa, territorio-mondo del baronetto
            Cosimo Piovasco di Rondò. Tuttavia, pur senza essere
        ...
        <div className={SheetStyles.gridRow} style={{marginTop:'3rem'}}>
          <div className={SheetStyles.paragraph}>
            <p>Il fatto poi che Terralba e Ombrosa
            siano in qualche modo riconducibili alla Liguria, terra natale di
            Calvino, è doppiamente significativo. Nel 1965 lo stesso
            scrittore, con lo pseudonimo-anagramma di Tonio Cavilla,
            sottolinea l’importanza del paesaggio ligure sullo sfondo del
            <em> Barone rampante</em>: «Il romanzo si svolge in un paese immaginario,
            Ombrosa, ma ci rendiamo presto conto che questa Ombrosa si trova
            in un punto imprecisato della Riviera ligure» (RR, III, 1228-29).
            Evocare il paesaggio ligure, che per Calvino è il paesaggio per
            eccellenza, assume allora la precisa finalità di riallacciamento
            lirico con un passato mitizzato, in polemica con le trasformazioni
        ...
        <div className={SheetStyles.gridRow} style={{marginTop:'3rem'}}>
                  <div className={SheetStyles.paragraph}>
                      <p>
                      Un discorso diverso, ma non così distante, può essere fatto per le <em>Città invisibili</em>,
            ...
            <div className={SheetStyles.gridRow}>
              <h2 className={SheetStyles.titleH2}>I racconti</h2>
                      ...
                      fantastiche. Due di questi testi (<em>Un paese disgraziato</em>, 1953; <em>Il generale in
