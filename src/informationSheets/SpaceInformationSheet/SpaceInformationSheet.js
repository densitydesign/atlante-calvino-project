      ...
      <>
        ...
        <main className={SheetStyles.main}>
          <div className={SheetStyles.gridRow}>
            <h4 className="ac-breadcrumb">{this.props.t("breadcrumb")}</h4>
            <h1 className={SheetStyles.titleH1}>{this.props.t("titolo")}</h1>
          </div>
          <div className={SheetStyles.gridRow}>
            <img
            ...
            <img
              ...
              src={inventati}
            />
            <h2 className={SheetStyles.titleH2}>{this.props.t("titleH2")}</h2>
            <div className={SheetStyles.paragraph}>
              <Trans
                i18nKey={"testo_analisi"}
                t={this.props.t}
                ns="luoghi-sheet"
              >
                <p>
                  ...
                  <strong>(1)</strong> in cui è ambientato il racconto{" "}
                  <em>Isabella e Fioravanti</em>; l’ultimo, nel 1982, è{" "}
                  <em>Casa Palomar</em> <strong>(2)</strong>, la dimora
                  ...
                  esame le tre differenti sezioni si evidenziano tuttavia
                  caratteristiche intrinseche molto diverse. Vediamo quali.
                </p>
              </Trans>
            </div>
          </div>
          <div className={SheetStyles.gridRow}>
            <div className={SheetStyles.paragraph}>
              <h3 className={SheetStyles.subtitleSheet}>
                {this.props.t("subtitle_romanzi")}
              </h3>
              <Trans
                i18nKey={"testo_romanzi"}
                t={this.props.t}
                ns="luoghi-sheet"
              >
                <p>
                  ...
                  <em>Trilogia degli antenati</em>, ambientate tra gli alberi di
                  Ombrosa e i boschi di Terralba. Oppure alle città visionarie e
                  simboliche esplorate da Marco Polo nelle Città invisibili, o
                  ancora, ai luoghi dai nomi impronunciabili – Petkwo, Kudgiwa,
                  Oquedal – in cui si muovono i personaggi di{" "}
                  <em>Se una notte d’inverno un viaggiatore</em>. Il modo in cui
                  queste ambientazioni fantastiche si inseriscono nel tessuto
                  narrativo delle storie merita tuttavia uno sguardo più
          ...
          <Trans i18nKey={"text"} t={this.props.t} ns="luoghi-sheet">
            <div className={SheetStyles.gridRow} style={{ marginTop: "3rem" }}>
              <div className={SheetStyles.paragraph}>
                <p>
                  In apparenza questo non accade nel <em>Barone rampante</em>,
                  ambientato nel libero comune di Ombrosa, territorio - mondo
                  del baronetto Cosimo Piovasco di Rondò. Tuttavia, pur senza
                  essere esplicitamente incorniciata all’ interno di un luogo
                  ...
                  doppiamente significativo. Nel 1965, è lo stesso scrittore,
                  con lo pseudonimo - anagramma di Tonio Cavilla, a sottolineare
                  l’ importanza del paesaggio ligure sullo sfondo:
                </p>
                <p className={" cite "}>
                  "C’è, quasi nascosto dentro il libro, un altro libro più
                  sommesso, di nostalgica evocazione d’ un paesaggio, o meglio:
                  di ri - invenzione d’ un paesaggio attraverso la composizione,
                  l’ ingrandimento, la moltiplicazione di sparsi elementi di
                  memoria. [...] Il romanzo si svolge in un paese immaginario,
                  Ombrosa, ma ci rendiamo presto conto che questa ombrosa si
                  trova in un punto imprecisato della Riviera ligure.Dai dati
                  biografici dell’ Autore sappiamo che egli è di San Remo, che
                  nella cittadina ligure ha passato infanzia e giovinezza fino
                  all’ immediato dopoguerra; da altri scritti dell’ Autore il
                  suo legame col paese risulta nutrito di memorie più
                  antiche[...].
                </p>
              </div>
          ...
          <div className={SheetStyles.gridRow}>
            ...
            <Trans i18nKey={"text_bibliografia"} t={this.props.t} ns="luoghi-sheet">
            <ol className={SheetStyles.paragraph + " references "}>
              <li className={SheetStyles.referenceItem}>
                Frank Zipfel, Fiktion, Fiktivität, Fiktionalität: Analysen zur
                Fiktion in der Literatur und zum Fiktionsbegriff in der
                Literaturwissenschaft, Erich Schmidt Verlag, Berlin 2001.
                Barbara Piatti, Die Geographie der Literatur. Schauplätze,
                Handlungsräume, Raumphantasien, Wallstein, Göttingen 2008.
              </li>
              <li className={SheetStyles.referenceItem}>
                Cfr. Barbara Patti et al, Mapping Literature: Towards a
                Geography of Fiction, in William Cartwright, Georg Gartner,
                Antje Lehn (a cura di), Cartography And art, Springer, Berlin
                2009, pp. 177-199. O anche Anne-Kathrin Reuschel, Lorenz Hurni,
                Mapping Literature: Visualisation of Spatial Uncertainty in
                Fiction, «The Cartographic Journal», vol. 48, n. 4, 2011, p.
                296.
              </li>
              <li className={SheetStyles.referenceItem}>
                Francesca Serra, Calvino, Salerno, Roma 2006, p. 322.
              </li>
              <li className={SheetStyles.referenceItem}>
                «Calvino è sempre stato un narratore che non sente il romanzo,
                che persino ne diffida. Narratore anti-romanzesco: nel senso che
                la problematica sociale e morale, la scienza della vita
                quotidiana come microstoriografia, che caratterizzano il romanzo
                moderno, sono sempre stati fuori del suo orizzonte». Alfonso
                Berardinelli, Calvino moralista. Ovvero restare sani dopo la
                fine del mondo, in «Diario», VII, 9, 1991, p. 39
              </li>
            </ol>
            </Trans>
          </div>
