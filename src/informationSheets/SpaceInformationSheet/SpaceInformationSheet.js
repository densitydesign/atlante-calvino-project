          ...
          <img className = {SheetStyles.image} style={{gridColumn:'1 / span 12'}} src={inventati}/>
              <h2 className={SheetStyles.titleH2}>L'analisi</h2>
                ...
                <div className={SheetStyles.sideContent}>
                    <img className={SheetStyles.image} style={{position:'sticky',top:'calc(var(--navigation-height)+2px)'}} src={zoom_03}/>
                </div>
                    <p className={SheetStyles.paragraph}>
                      ...
                      <div className={SheetStyles.sideContent}>
                        <img className={SheetStyles.image} style={{position:'sticky',top:'calc(var(--navigation-height)+2px)'}} src={zoom_01}/>
                      </div>
                    <p className={SheetStyles.paragraph}>
                      <span className="cite">
                  ...
                  <p className={SheetStyles.paragraph}>
                    ...
                    <div className={SheetStyles.sideContent}>
                      <img className={SheetStyles.image} style={{position:'sticky',top:'calc(var(--navigation-height)+2px)'}} src={zoom_02}/>
                    </div>
                  </div>
