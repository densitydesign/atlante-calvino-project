  ...
  render() {
    return (
      <div className={S["splash-container"]}>
        ...
        <div className={S["subtitle"]}><Link to="/" className={S['disabled-link']}><h2 style={{backgroundColor: 'var(--cool-bg)', textAlign:'center'}}>Letteratura e visualizzazione</h2></Link></div>
        <div className={S["arrow-down"]}><Link to="/" className={S['disabled-link']}><div><BsArrowDown color="var(--dark-blue)"/></div></Link></div>
