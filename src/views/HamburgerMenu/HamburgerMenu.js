      ...
      <div className="hamburger-menu-container">
        ...
        <div className="hamburger-menu">
          ...
          <div className="hamburger-menu-cell-grid">
            ...
            <ViewSelector className="hamburger-menu-cell" route="Itineraries/#doubt" text="Dubbio"><h3 dataClass="ciaociao"/></ViewSelector>
            <ViewSelector className="hamburger-menu-cell" route="Itineraries/#spaces" text="Spazi"><h3/></ViewSelector>
            <ViewSelector className="hamburger-menu-cell" route="Itineraries/#shape" text="Forma"><h3/></ViewSelector>

            <ViewSelector className="hamburger-menu-cell" route="Phenomena/intro" text="Fenomeno"><h4/></ViewSelector>
            ...
            <ViewSelector className="hamburger-menu-cell" route="Process/intro" text="Processo"><h4/></ViewSelector>
            ...
            <ViewSelector className="hamburger-menu-cell" route="Problem/intro" text="Problema"><h4/></ViewSelector>
