      ...
      <div className="hamburger-menu-container">
        ...
        <div className="hamburger-menu hamburger-menu-open">
          ...
          <div className="hamburger-menu-cell-grid">
            ...
            <ViewSelector className="hamburger-menu-cell" route="Phenomena/territory/doubtAnalysis" text="Nebbia"><h5 dataClass=""/></ViewSelector>
            <ViewSelector className="hamburger-menu-cell" route="Phenomena/territory/spaceAnalysis" text="Luoghi"><h5 dataClass=""/></ViewSelector>
            <ViewSelector className="hamburger-menu-cell" route="Phenomena/territory/shapeAnalysis" text="Elenchi"><h5 dataClass=""/></ViewSelector>
