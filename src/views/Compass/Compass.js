      ...
      <div>
        ...
        <div className="compass-main-description">
          ...
          <p className='text-dark-blue'>
            ...
            racconti, Il tempo e le opere e L’arcipelago dei nomi che aiutino a
            muoversi dentro l’intero corpus dell’opera e che siano sempre a
            portata di mano. Fornendo un colpo d’occhio sulla storia dei volumi,
            sulla vicenda dei racconti e sulla biblioteca mentale dell’autore.
          </p>
        </div>
        <div>
          <SlidingPanel
