...
export default class CompassTime extends React.Component {
  render() {
    ...
    return (
      <>
        <HamburgerCompassHeader toggleTempoEOpere={this.props.toggleTempoEOpere} />
        <div id="main--sinuous">
            ...
            <div className="row intro">
              <div className="col-12 col-lg-9">
                ...
                <p>
                  ...
                  opere pubblicate in quarant&#x2019;anni di attivit&#xE0; e le
                  collaborazioni giornalistiche pi&#xF9; durature. Ha una forma
                  sinusoidale che mette in evidenza la scansione temporale in
                  decenni e le differenti direzioni intraprese e sperimentate
                  nel corso del tempo.
                </p>
                <p>
                  A ogni volume &#xE8; assegnato un simbolo, che consente da un
                  lato di individuare il genere letterario di appartenenza di
                  ciascuna opera e dall&#x2019;altro di cogliere il rapporto
                  spesso significativo tra generi e decenni.
                </p>
                <p className="item-reset-top" data-attribute="reset">
                  ...
                  principali collaborazioni di Calvino con i quotidiani: i circa
                  trecento articoli scritti per &#xAB;l&#x2019;Unit&#xE0;&#xBB;,
                  i settanta per il &#xAB;Corriere della Sera&#xBB; e i
                  centoquaranta per &#xAB;la Repubblica&#xBB;.
                </p>
              </div>
                ...
                <div>
                  ...
                  >
                    <div>
                      ...
                      <p className="mb-0">
                        Clicca sullo sfondo bianco per cancellare la selezione.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="item anni40" data-attribute="anni40">
                    ...
                    <p>
                      ...
                      ). Quando esce il suo primo libro ha 24 anni, essendo nato
                      il 15 ottobre 1923 a Santiago de Las Vegas. I racconti
                      sono gi&#xE0; usciti prevalentemente su riviste e
                      giornali, soprattutto sulle pagine de
                      &#xAB;l&#x27;Unit&#xE0;&#xBB;, alla quale Calvino
                      collabora dal 1946 al 1955. L&#x27;editore di tutti i suoi
                      principali libri &#xE8; Einaudi, presso il quale Calvino
                      lavora a lungo, prima come redattore poi come dirigente.
                      Tra il 1947 il 1983 Calvino pubblica con Einaudi
                      venticinque libri, vendendo circa quattro milioni di
                      volumi. Si pu&#xF2; dire anzi che li abbia fabbricati
                      fisicamente, curando anche la scelta delle copertine,
                      delle immagini, dei risvolti.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="item anni50" data-attribute="anni50">
                    ...
                    <p>
                      ...
                      <span className="work-title ibrido" data-attribute="V003">
                        Il visconte dimezzato
                      </span>
                      ) e una raccolta di tre lunghi racconti autobiografici di
                      guerra (
                      <span
                        className="work-title racconti"
                        data-attribute="V004"
                      ...
                      testimonianza della difficolt&#xE0; che incontra con tale
                      genere narrativo. Quindi a met&#xE0; degli Anni 50 si
                      dedica al lavoro di raccolta e riscrittura delle{" "}
                      <span
                      ...
                      raccolta antologica dei racconti scritti dall&#x27;inizio
                      della sua carriera fino al tempo presente (
                      <span
                        className="work-title racconti"
                        data-attribute="V007"
                      >
                      ...
                      e{" "}
                      <span className="racconti">L&#x27;entrata in guerra</span>
                ...
                >
                  <div className="item anni60" data-attribute="anni60">
                    ...
                    <p>
                      ...
                      sperimenta vari esempi di forme ibride tra romanzo breve e
                      racconto lungo.{" "}
                      <span className="work-title ibrido" data-attribute="V010">
                        La speculazione edilizia
                      </span>
                      ,{" "}
                      <span className="work-title ibrido" data-attribute="V012">
                        La nuvola di smog
                      </span>{" "}
                      e{" "}
                      <span className="work-title ibrido" data-attribute="V012">
                      ...
                      <span className="work-title ibrido" data-attribute="V009">
                      ...
                      del 1968. Alla fine degli anni 60 inaugura un nuovo genere
                      di ibridazioni destinato a imporsi negli anni 60: il
                      romanzo di racconti racchiusi dentro una cornice (
                      <span
                ...
                >
                  <div className="item anni70" data-attribute="anni70">
                    ...
                    <p>
                      ...
                      gi&#xE0; praticata con le fiabe. Ma soprattutto continua a
                      dedicarsi alla forma ibrida tra romanzo e raccolta di
                      ...
                      <span className="font-italic">Palomar</span> vede la luce
                      a met&#xE0; degli Anni 70 sulle pagine del &#xAB;Corriere
                      della Sera&#xBB;, a cui Calvino collabora dal 1974 al
                      1979. A partire dal 1979 passa a &#xAB;la
                ...
                >
                  <div className="item anni80" data-attribute="anni80">
                    ...
                    <p>
                      ...
                      corso del tempo (
                      <span className="work-title saggi" data-attribute="V020">
                        Una pietra sopra
                      </span>{" "}
                      e
                      <span className="work-title saggi" data-attribute="V022">
                      ...
                      l&#x27;ultimo pubblicato nelle edizioni Einaudi, prima del
                      passaggio a Garzanti. Ancora una volta un libro pi&#xF9;
                      simile a una raccolta di racconti che a un romanzo,
                      essendo costituito da una serie di pezzi brevi (gi&#xE0;
                      usciti per lo più sui giornali) con un unico protagonista.
                      Nel frattempo lavora su pi&#xF9; tavoli, progettando una
                      serie di libri che la morte improvvisa lascer&#xE0;
                      incompiuti.
                    </p>
                    <p>
                ...
                >
                  <div className="item anni90" data-attribute="anni90">
                    ...
                    <p>
                      ...
                      collana de{" "}
                      <span className="work-title postumi">I Meridiani</span> di
                      Mondadori, con un ricco apparato di note ai testi. Saranno
                      otto alla fine i volumi che canonizzano Calvino come uno
                      dei grandi classici della letteratura contemporanea (3 di{" "}
                      <span className="font-italic">Romanzi e racconti</span>, 1
                      di <span className="font-italic">Fiabe</span>, 2 di{" "}
