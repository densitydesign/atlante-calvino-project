...
*/}
        ...
        <div id="staticGrid" className="atlas-intro">
          ...
          <div className="atlas-intro-cell-grid2">
            ...
            <IntroViewSelector className="atlas-intro-cell2 pop" image="/menuImages/menu_tappa_1.svg" transitionData={transitionData} keepLabelVisible><h4>TAPPA 1</h4></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} image="/menuImages/menu_nebbia.svg" keepLabelVisible><h5>Nebbia</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} image="/menuImages/menu_luoghi.svg" keepLabelVisible><h5>Luoghi</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} image="/menuImages/menu_elenchi.svg" keepLabelVisible><h5>Elenchi</h5></IntroViewSelector>
            ...
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} keepLabelVisible image="/menuImages/menu_dubitare.svg" ><h5>Dubitare</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} image="/menuImages/menu_trasformare.svg" keepLabelVisible><h5>Trasformare</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} image="/menuImages/menu_trama.svg" keepLabelVisible><h5>Combinare</h5></IntroViewSelector>
            ...
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} keepLabelVisible><h5>Cancellazione</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} keepLabelVisible><h5>Realismo</h5></IntroViewSelector>
            <IntroViewSelector className="atlas-intro-cell2" transitionData={transitionData} keepLabelVisible><h5>Trama</h5></IntroViewSelector>
