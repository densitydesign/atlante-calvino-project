      ...
      <>
        ...
        <div className="phenomena-intro-grid">
          ...
          <div className="itineraries-subgrid">
            <LinkParagraph route="/territory" linkText="Nebbia" description="All’inizio c’è la nebbia. Una fitta nebbia, dove il territorio si cancella e il suo significato ci sfugge. La nebbia è uno dei grandi fenomeni della scrittura calviniana, per questo abbiamo scelto di cominciare da qui." />
