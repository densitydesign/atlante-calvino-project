...
export default class CompassFlux extends React.Component {
  render() {
    ...
    return (
      <>
        <HamburgerCompassHeader toggleFlowOfStories={this.props.toggleFlowOfStories} />
          ...
          <div className="row intro">
            ...
            <div className="col-8 col-xl-8">
              <p>
                ...
                racconti pubblicati da Italo Calvino, che hanno spesso visto la
                luce su riviste e quotidiani prima di confluire nelle raccolte.
                La scrittura dei racconti ha occupato Calvino per tutto
                l&#x2019;arco della sua carriera e costituisce la spina dorsale
                della sua opera. La maggior parte dei testi &#xE8; uscita in
                prima battuta su quotidiani e riviste (mostrati sulla sinistra),
                che nel corso del Novecento hanno largamente contribuito alla
                fortuna della narrativa breve.
              </p>
              <p>
                Per Calvino, i singoli racconti trovano un ulteriore senso una
                volta collocati all&#x2019;interno delle raccolte (mostrate
                invece sulla destra), grazie al loro combinarsi con altri testi.
                Combinarsi ma anche ricombinarsi, perch&#xE9; spesso le raccolte
                sono soggette a ricomposizione e il flusso di un singolo
                racconto pu&#xF2; attraversare diverse tappe editoriali.
              </p>
              <p>
                Le tre grandi famiglie genealogiche dei racconti gravitano
                intorno all’antologia dei{" "}
                <span className="font-italic">Racconti</span>, alla serie delle{" "}
                <span className="font-italic">Cosmicomiche</span> e infine a{" "}
                <span className="font-italic">Palomar</span>.
              </p>
            </div>
            <div className="col-3 col-xl-3">
              <h4 style={{ marginBottom: "2rem" }}>
                Come si legge la visualizzazione:{" "}
              </h4>
